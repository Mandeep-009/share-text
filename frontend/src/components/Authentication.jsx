...
const Authentication = ({authenticated}) => {
  ...
  return (
    <div>
      ...
      <div>
        <input type="text" onChange={(e)=>setCode(e.target.value)} onKeyDown={(e)=>{if(e.key==="Enter"){checkCode()}}} style={{height:'30px',width:'200px',fontSize:'18px',margin:'10px 0 30px 0',backgroundColor:'#222221',color:'white', border:'1px solid white'}}/>
      </div>
